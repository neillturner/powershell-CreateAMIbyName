        ...
        switch ($instance.state.code)
        {
            ...
            { ($_ -eq 16) -or ($_ -eq 80) } {
                ...
                else
                {
                    ...
                    New-EC2Tag -resourceIdSet $amiID -Tag $tag
                    New-EC2Tag -resourceIdSet $amiID -Tag $tagDesc
                    New-EC2Tag -resourceIdSet $amiID -Tag $tagPlat
                    ...
                    ForEach-Object -Process { New-EC2Tag -resourceIdSet $_.SnapshotID -Tag $tag } # Add tags to snapshots associated with the AMI using Amazon.EC2.Model.EbsBlockDevice
